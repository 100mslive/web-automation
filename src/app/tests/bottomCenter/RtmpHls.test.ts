...
test.describe("Beam tests @beam", () => {
  ...
  test(`Start and Stop Browser Recording`, async () => {
    await page.click(
      ...
      page.bottomCenter.streaming_recording_btn,
      page.bottomCenter.recording_checkbox,
      page.bottomCenter.rtmp_recording_start_btn
    );

    await page.clickWithTimeout(
      beamWaitTimeout,
      page.topRight.record_status_dropdown,
      page.topRight.browser_recording,
      page.bottomCenter.more_settings_btn,
      page.bottomCenter.streaming_recording_btn,
      page.bottomCenter.rtmp_recording_stop_btn
    );
  });
  ...
  test(`Start and Stop HLS`, async () => {
    await page.click(
      page.bottomCenter.more_settings_btn,
      page.bottomCenter.streaming_recording_btn,
      page.bottomCenter.hls_checkbox,
      page.bottomCenter.rtmp_recording_start_btn
    );
  ...
  test(`Start and Stop Rtmp`, async () => {
    ...
    await page.sendText(page.bottomCenter.streaming_rtmp_url_field, process.env.twitch_rtmp_url);
  ...
  test(`Start and Stop Rtmp Recording`, async () => {
    ...
    await page.sendText(page.bottomCenter.streaming_rtmp_url_field, process.env.yt_rtmp_url);
