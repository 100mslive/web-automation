...
test.skip(`Screenshare check`, async ({ context }) => {
  ...
  result = await pageMethods.isElementVisible(
    page2,
    bottomCenter.screen_share_btn,
    "screen_share_btn visibility-"
  );
  pageMethods.assertResult(result, "screen_share_btn");
  await pageMethods.clickElement(
    page2,
    bottomCenter.screen_share_btn,
    "screen_share_btn"
  );
  ...
  result = await pageMethods.isElementVisible(
    page2,
    bottomCenter.stop_screen_share_btn,
    "stop_screen_share_btn visibility-"
  );
